...
class __TwigTemplate_ee0c1379988b3f75c44a8e0feec8a6c9 extends Template
{
      ...
      <tbody>
        ...
        if (($context["topics"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["topic"]) {
                // line 16
                yield "            <tr";
                if ( !CoreExtension::getAttribute($this->env, $this->source, $context["topic"], "status", [], "any", false, false, false, 16)) {
                    yield " class=\"table-disabled\"";
                }
                yield ">
              <td class=\"text-center\"><input type=\"checkbox\" name=\"selected[]\" value=\"";
                // line 17
                yield CoreExtension::getAttribute($this->env, $this->source, $context["topic"], "topic_id", [], "any", false, false, false, 17);
                yield "\" class=\"form-check-input\"/></td>
              <td>";
                // line 18
                yield CoreExtension::getAttribute($this->env, $this->source, $context["topic"], "name", [], "any", false, false, false, 18);
                yield "</td>
              ...
              <td class=\"text-end\">";
                // line 24
                yield CoreExtension::getAttribute($this->env, $this->source, $context["topic"], "sort_order", [], "any", false, false, false, 24);
                yield "</td>
              <td class=\"text-end text-nowrap\"><a href=\"";
                // line 25
                yield CoreExtension::getAttribute($this->env, $this->source, $context["topic"], "edit", [], "any", false, false, false, 25);
                yield "\" data-bs-toggle=\"tooltip\" title=\"";
                yield ($context["button_edit"] ?? null);
                yield "\" class=\"";
                if ( !CoreExtension::getAttribute($this->env, $this->source, $context["topic"], "status", [], "any", false, false, false, 25)) {
...
";
    ...
    {
        return array (  177 => 38,  173 => 37,  167 => 33,  161 => 30,  158 => 29,  155 => 28,  138 => 25,  134 => 24,  131 => 23,  125 => 22,  119 => 20,  117 => 19,  113 => 18,  109 => 17,  102 => 16,  97 => 15,  95 => 14,  88 => 10,  76 => 9,  64 => 8,  52 => 7,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("<form id=\"form-topic\" method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"{{ action }}\" data-oc-target=\"#list\">
  <div class=\"table-responsive\">
    <table class=\"table table-bordered table-hover\">
      <thead>
        <tr>
        ...
        {% if topics %}
          {% for topic in topics %}
            <tr{% if not topic.status %} class=\"table-disabled\"{% endif %}>
              ...
              <td class=\"text-end text-nowrap\"><a href=\"{{ topic.edit }}\" data-bs-toggle=\"tooltip\" title=\"{{ button_edit }}\" class=\"{% if not topic.status %}btn btn-secondary{% else %}btn btn-primary{% endif %}\"><i class=\"fa-solid fa-pencil\"></i></a></td>
            </tr>
          {% endfor %}
        {% else %}
          <tr>
...
", "admin/view/template/cms/topic_list.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\cms\\topic_list.twig");
    }
}
