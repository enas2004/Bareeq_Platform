...
class __TwigTemplate_fe73475d3ec1643f463852b5af808e5b extends Template
{
        ...
        if (($context["customer_groups"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
              ...
              <td>";
                ...
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 17) == ($context["customer_group_id"] ?? null))) {
                    yield " <strong>(";
  ...
  <div class=\"row\">
    ...
    {
        return array (  143 => 32,  139 => 31,  133 => 27,  127 => 24,  124 => 23,  121 => 22,  110 => 19,  106 => 18,  97 => 17,  93 => 16,  90 => 15,  85 => 14,  83 => 13,  76 => 9,  64 => 8,  52 => 7,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("<form id=\"form-customer-group\" method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"{{ action }}\" data-oc-target=\"#list\">
  <div class=\"table-responsive\">
    <table class=\"table table-bordered table-hover\">
      <thead>
        <tr>
        ...
        {% if customer_groups %}
          {% for customer_group in customer_groups %}
            <tr>
              ...
              <td>{{ customer_group.name }}{% if customer_group.customer_group_id == customer_group_id %} <strong>({{ text_default }})</strong>{% endif %}</td>
...
</form>", "admin/view/template/customer/customer_group_list.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\customer\\customer_group_list.twig");
    }
}
