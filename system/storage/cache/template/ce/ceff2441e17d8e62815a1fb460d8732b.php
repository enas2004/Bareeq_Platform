...
class __TwigTemplate_23cd3028a4737f3f0ba362d2545de9e9 extends Template
{
        ...
        if (($context["coupons"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["coupon"]) {
              ...
              <td class=\"text-end text-nowrap\"><a href=\"";
                ...
                yield "\" class=\"";
                if ( !CoreExtension::getAttribute($this->env, $this->source, $context["coupon"], "status", [], "any", false, false, false, 25)) {
...
";
    ...
    {
        return new Source("<form id=\"form-coupon\" method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"{{ action }}\" data-oc-target=\"#list\">
  <div class=\"table-responsive\">
    <table class=\"table table-bordered table-hover\">
      <thead>
        <tr>
        ...
        {% if coupons %}
          {% for coupon in coupons %}
            <tr{% if not coupon.status %} class=\"table-disabled\"{% endif %}>
              ...
              <td class=\"text-end text-nowrap\"><a href=\"{{ coupon.edit }}\" data-bs-toggle=\"tooltip\" title=\"{{ button_edit }}\" class=\"{% if not coupon.status %}btn btn-secondary{% else %}btn btn-primary{% endif %}\"><i class=\"fa-solid fa-pencil\"></i></a></td>
            </tr>
          {% endfor %}
        {% else %}
          <tr>
...
", "admin/view/template/marketing/coupon_list.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\marketing\\coupon_list.twig");
    }
}
